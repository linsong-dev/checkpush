...
| 7 | 2026-08-08 | `待填` | 技能资源目录同步（engine/hooks/config/references/agents + dgen_rules.md/requirements.txt）→ 插件包 skills/<name>/ 对齐系统插件结构 + 插件信息 1.3.0 |

> 待推送：1.3.0（技能资源目录同步 + 插件包对齐系统结构）
