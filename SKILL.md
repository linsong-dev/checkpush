...
| 5 | 2026-08-08 | `待填` | sync 一键化：assets 资源同步 + --agents/--plugin 重装（.agents 源→cachebuster→codex plugin add）；参照系统自带插件结构补齐插件包（README/AGENTS/LICENSE/assets）+ 插件信息 1.2.0 |

> 待推送：1.2.0（sync 一键化 + 插件包结构补齐）
